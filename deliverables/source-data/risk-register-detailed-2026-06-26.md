...
AtlasPay uses a 5x5 risk matrix (industry-standard practice commonly attributed to ISO 27005-aligned methodology). Probability and impact are scored 1-5. Risk level is computed as `grid[probability][impact]` lookup. Risk levels: 1=Very Low, 2=Low, 3=Medium, 4=High, 5=Very High.
...
The 5x5 risk matrix below shows where each AtlasPay risk plots on a likelihood vs impact grid. INHERENT (left) represents pre-control exposure; RESIDUAL (right) shows post-control position after POA&M execution.

![Figure 1: AtlasPay 5x5 Risk Heatmap - INHERENT vs RESIDUAL](../../assets/images/atlaspay-risk-heatmap.png)
