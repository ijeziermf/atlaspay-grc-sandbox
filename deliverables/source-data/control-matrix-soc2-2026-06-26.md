...
| C1.2 | Disposal of confidential information | ACC-01 | R-02 | Met | Encrypted media disposal, retention schedule, secure deletion procedures |

---

## Summary

The stacked bar chart below shows control coverage broken down by Common Criteria category. 38 criteria total: 31 Met (82%), 7 Partial (18%), 0 Missing.

![Figure 1: AtlasPay SOC 2 Control Coverage by Common Criteria Category](../../assets/images/atlaspay-control-coverage.png)
...
| Missing | 0 | 0% |
| Not Applicable | 0 | 0% |
| **Total criteria evaluated** | **38** | (33 Common Criteria + 3 Availability + 2 Confidentiality) |

**Note:** SOC 2 Trust Services Criteria 2017 (revised 2022) defines 33 Common Criteria (CC1.1-CC9.2), 3 Availability criteria (A1.1-A1.3), 2 Confidentiality criteria (C1.1-C1.2), 5 Processing Integrity criteria (PI1.1-PI1.5), and 18 Privacy criteria (P1.1-P8.1). A standard Security+Availability+Confidentiality SOC 2 report covers 33+3+2 = 38 criteria, all of which AtlasPay has evaluated.
