...
- ⚠️ **Partial** — Risk treatment in progress; partial mitigation only
...
| Likelihood ↓ / Impact → | Negligible (1) | Minor (2) | Significant (3) | Critical (4) | Catastrophic (5) |
|---|---|---|---|---|---|
...
**Current risk:** Probability 3 (Likely) × Impact 5 (Catastrophic) = High (4)
...
**Current risk:** Probability 4 (Very likely) × Impact 4 (Critical) = High (4)
...
**Residual risk:** Probability 1 (Unlikely) × Impact 2 (Significant) = **Low (2)**
...
**Prepared by:** IfeSec Risk Advisory
