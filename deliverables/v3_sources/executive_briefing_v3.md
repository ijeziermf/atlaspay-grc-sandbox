...
| Likelihood ↓ / Impact → | Negligible (1) | Minor (2) | Serious (3) | Critical (4) | Catastrophic (5) |
|---|---|---|---|---|---|
| **Almost Certain (5)** | — | — | — | — | — |
...
|---|---|---|
| A1.1 | Capacity planning and availability commitments | ⚠️ Partial |
| A1.2 | Environmental protections | ✅ Covered (V-01 AWS) |
| A1.3 | Backup and recovery | ⚠️ Partial |
| C1.1 | Identify confidential information | ✅ Covered |
| C1.2 | Dispose of confidential information | ⚠️ Partial |
...
- ✅ 7/7 vendors under MSA with security addenda
...
- ⚠️ Tier-3 vendor (V-06) relies on self-attestation — gap noted in CC9.2
- 🟡 [LAB-SYNTHETIC] Vendor risk scoring rubric (drafted 2026-06, awaiting CISO sign-off)
...
| Vendor SOC 2 reports | 6 of 7 | ⚠️ V-06 self-attestation only |
| Penetration test reports | 1 of 4 | ⚠️ Quarterly cadence not yet established |
| Backup restore test records | 4 | ✅ Quarterly cadence established |
| Incident response tabletop | 1 | ⚠️ Annual cadence pending |
| Board reporting minutes | 0 | 🟡 [LAB-SYNTHETIC] Q3 2026 first meeting |
| Access review evidence | 2 | ⚠️ Quarterly cadence established 2026-Q2 |
...
|---|---|---|
| AtlasPay_SOC2_Executive_Briefing_v3.pdf | `deliverables/AtlasPay_SOC2_Executive_Briefing_v3.pdf` | Board, CISO, CTO |
| AtlasPay_SOC2_Risk_Register_v3.pdf | `deliverables/AtlasPay_SOC2_Risk_Register_v3.pdf` | Board, CISO, Engineering Leads |
| AtlasPay_SOC2_Control_Mapping_v3.pdf | `deliverables/AtlasPay_SOC2_Control_Mapping_v3.pdf` | Auditors, Engineering |
| AtlasPay_SOC2_Gap_Assessment_v3.pdf | `deliverables/AtlasPay_SOC2_Gap_Assessment_v3.pdf` | CISO, Engineering Leads |
| AtlasPay_SOC2_Audit_Walkthrough_v3.pdf | `deliverables/AtlasPay_SOC2_Audit_Walkthrough_v3.pdf` | Auditors |
| CISO Assistant state | `lab/ca_state_export.json` | Engineering, Auditors |
| Lab docs (working papers) | `lab/docs/` | IfeSec internal |
...
**Prepared by:** IfeSec — ijezie Risk Advisory
